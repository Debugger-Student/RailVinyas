    ...
    return (
      <div className="rounded-xl bg-slate-50 border border-slate-100 p-6 text-center">
        ...
        <div className="text-[11px] text-gray-400 mt-1">
          This chart fills in once maintenance recommendations have been
          generated.
        </div>
      </div>
    );
    ...
    <div className="flex flex-col sm:flex-row items-center gap-6">
      ...
      <div className="grid grid-cols-2 gap-3 flex-1 w-full">
        {["LOW", "MEDIUM", "HIGH", "VERY_HIGH"].map((level) => (
          <div
            key={level}
            className="rounded-xl bg-slate-50 border border-slate-100 px-3 py-3"
          >
...
export default function Dashboard() {
  ...
  return (
    <div className="max-w-[1400px] mx-auto space-y-7 pb-10">
      ...
      {/* =========================================================
          PRIMARY SOLUTION — NEW BLOCK PLANNING
      ========================================================= */}

      <section>
        <div className="relative overflow-hidden rounded-[28px] border-2 border-sky-400/70 bg-gradient-to-br from-[#062F49] via-[#075985] to-[#0EA5E9] shadow-[0_15px_55px_rgba(14,165,233,0.30)]">

          {/* Decorative glow */}
          <div className="absolute -right-20 -top-20 h-72 w-72 rounded-full bg-cyan-300/20 blur-3xl" />

          <div className="absolute -left-20 -bottom-24 h-72 w-72 rounded-full bg-sky-300/15 blur-3xl" />

          {/* Indian tricolor highlight */}
          ...
          <div className="relative p-7 lg:p-9">
            ...
            <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-7">
              ...
              <div className="max-w-3xl">
                ...
                {/* Primary badge */}
                <div className="inline-flex items-center gap-2 rounded-full bg-amber-400 text-[#062F49] px-4 py-2 text-[10px] uppercase tracking-[0.16em] font-extrabold shadow-lg">
                ...
                <div className="flex items-center gap-4 mt-5">
                  ...
                  <div className="h-16 w-16 shrink-0 rounded-2xl bg-white/15 border border-white/20 backdrop-blur-sm flex items-center justify-center text-3xl shadow-lg">
                    🚆
                  </div>

                  <div>

                    <div className="text-[10px] uppercase tracking-[0.18em] font-bold text-cyan-200">
                      Railway Maintenance Planning
                    </div>

                    <h2 className="text-3xl lg:text-4xl font-extrabold tracking-tight text-white mt-1">
                      New Block Planning
                    </h2>
                ...
                <p className="text-sm lg:text-base leading-7 text-white/75 mt-5 max-w-2xl">
                  Generate an AI-assisted maintenance block recommendation
                  by evaluating traffic conditions, maintenance duration,
                  asset availability, overrun risk, and potential operational
                  disruption.
                </p>
              ...
              <div className="lg:w-[250px] shrink-0">
                ...
                <div className="rounded-2xl bg-white/10 border border-white/20 backdrop-blur-sm p-5">
                  ...
                  <div className="text-[10px] uppercase tracking-[0.16em] font-bold text-cyan-200">
                    Core Decision Module
                  </div>

                  <div className="flex items-center gap-3 mt-4">

                    <div className="h-10 w-10 rounded-xl bg-green-400/15 border border-green-300/20 flex items-center justify-center">
                      <span className="h-2.5 w-2.5 rounded-full bg-green-400 animate-pulse" />
                    </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 mt-8">
              ...
              {/* Traffic */}
              <div className="rounded-2xl bg-white/12 border border-cyan-200/20 p-4 backdrop-blur-sm hover:bg-white/18 transition">

                <div className="h-9 w-9 rounded-lg bg-cyan-300/15 text-cyan-200 flex items-center justify-center font-bold">
                  ≋
                </div>
                ...
                <div className="text-[11px] text-white/55 mt-1 leading-4">
                  Evaluate train movement and traffic intensity.
                </div>
              ...
              <div className="rounded-2xl bg-white/12 border border-cyan-200/20 p-4 backdrop-blur-sm hover:bg-white/18 transition">
                ...
                <div className="text-[11px] text-white/55 mt-1 leading-4">
                  Check availability of required maintenance assets.
                </div>
              ...
              <div className="rounded-2xl bg-white/12 border border-cyan-200/20 p-4 backdrop-blur-sm hover:bg-white/18 transition">
                ...
                <div className="text-[11px] text-white/55 mt-1 leading-4">
                  Estimate maintenance duration and overrun risk.
                </div>
              ...
              <div className="rounded-2xl bg-white/12 border border-cyan-200/20 p-4 backdrop-blur-sm hover:bg-white/18 transition">
                ...
                <div className="text-[11px] text-white/55 mt-1 leading-4">
                  Rank candidate windows by expected disruption.
                </div>
            ...
            {/* CTA */}
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-5 mt-8 pt-6 border-t border-white/15">

              <div>

                <div className="text-sm font-bold text-white">
                  Start the main RailVinyas planning workflow
                </div>

                <div className="text-[11px] text-white/50 mt-1">
                  Select a section, define maintenance requirements, and
              ...
              <Link
                to="/new-request"
                className="inline-flex items-center justify-center gap-3 rounded-xl bg-white text-[#062F49] px-6 py-3.5 text-sm font-extrabold shadow-xl hover:bg-amber-400 hover:text-[#062F49] hover:shadow-2xl transition-all duration-200"
              >
                START NEW BLOCK PLANNING
            ...
            {/* Formal note */}
            <div className="mt-5 text-[10px] text-white/40 leading-5">
              Decision-support module. Final maintenance block authorization
      ...
      <div className="grid grid-cols-1 xl:grid-cols-[1.15fr_0.85fr] gap-5">
        ...
        <Card className="overflow-hidden p-0">
          ...
          <div className="px-6 py-5 border-b border-gray-100">
            <SectionTitle
              ...
              subtitle={`Based on the ${
                recent.length || 0
              } most recent recommendation records, not the full network.`}
            />
          </div>
          ...
          <div className="p-6">
            ...
            {loading ? (
              <Spinner label="Loading traffic mix..." />
            ) : (
              <TrafficDonut
        ...
        {loading ? (
          ...
          <div className="p-10 text-center">
            ...
            <div className="text-xs text-gray-400 mt-1 max-w-sm mx-auto">
              Submit a request from the New Block Request page and it will
              appear here.
            </div>
              ...
              <div className="px-6 py-4 bg-sky/5 border-b border-sky/10">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm font-bold text-navy mt-1">
                      {latest.section_id} · {latest.from_station} →{" "}
                      {latest.to_station}
                    </div>
                ...
                <tbody>
                  ...
                  {recent.map((row, index) => (
                    ...
                    >
                      ...
                      <td className="px-4 py-4">
                        <TrafficBadge level={row.traffic_level} />
                      </td>
